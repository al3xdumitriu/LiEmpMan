	...
	<div class="col-lg-6">
		...
		<div class="well bs-component">
			<form name="accountForm" class="form-horizontal"
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" name="name" class="form-control"
							ng-model="accountCtrl.account.employeeId.name" ng-maxlength="255"
							required>
					</div>
					...
					<div style="color: red" ng-show="accountForm.name.$error.maxlength">Input
						must be less than or equal to 255 characters.</div>
				</div>
				<div class="form-group">
				...
				<div ng-show="accountForm.password.$error.minlength">Must be
